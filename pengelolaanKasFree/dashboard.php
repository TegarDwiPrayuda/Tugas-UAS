...
?>
    ...
    <center><marquee behavior="alternate" direction="" width="50%" scrolldelay="300" style="font-size: 19px; color: maroon;">Selamat Datang Di Sistem Informasi Pengelolaan Kas </marquee></center>
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h1>Dashboard</h1>
