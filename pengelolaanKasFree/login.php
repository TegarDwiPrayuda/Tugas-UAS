...
?>
    ...
    <head>
        ...
        <style>
            html{
                background-url('images/teknologi.jpg');
        ...
        <!-- Title Page-->
        <title>Sistem Informasi Pengelola Kas</title>
    ...
    <style type="text/css">
        body{
            background-image: url("images/teknologi.jpg");
        }
    </style>
                    ...
                    <div class="login-wrap">
                        <div class="login-content">
                            <div class="login-logo">
                                <h3>Selamat Datang Di Sistem Informasi Pengelolaan Kas</h3>
                            </div>
